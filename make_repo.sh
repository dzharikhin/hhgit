...
git -C repo add logo.data
git -C repo commit -m "bugfix [bugfix.png init.png] => logo.data"
...
git -C repo add logo.data
git -C repo commit -m "feature1 [refactoring.png init] => logo.data"
...
git -C repo add logo.data
git -C repo commit -m "feature2 [refactoring.png init feature2.png] => logo.data"
